...
Projet Foosus géoconscient (titre provisoire) Client : Foosus
...
## Contraintes et difficultés spécifiques aux parties prenantes à prendre en compte
...
Cette métrique a chuté rapidement au cours des derniers mois et doit être améliorée en priorité. L’expansion au sein des marchés locaux et le fait de fournir du géociblage sont vus comme des facteurs critiques pour toucher une gamme plus large d’utilisateurs.
...
*À FAIRE : À COMPLÉTER PAR LE NOUVEL ARCHITECTE*
...
<aside>
📋 **Principes à refléter durant un processus d’architecture Lean**
...
Voir la carte des flux de valeurs organisationnelle pour les flux actuels. À faire :
Nouveaux flux à définir par le nouvel architecte.